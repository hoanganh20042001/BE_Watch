...
const socket_getway_1 = require("../socket/socket.getway");
let PayService = class PayService {
    constructor(payRepository, orderRepository, productRepository, discountRepository, userRepository, mailService, gateway) {
